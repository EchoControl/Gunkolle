...
Gui, Add, DDL, x40 w60 ym-3 vWorldV, |4_3E||5_4|5_4_friendly|5_2E|0_2|1_3DD|3_6B
...
OffFindClick(OffX,OffY,x,y,v*)
{
	local RandX, RandY := v[1], radius := 5, counter := 0
	Random, OutX, -1.0, 1.0
	Random, Sign, -1.0, 1.0
	RandY += Round((sqrt(1 - OutX ** 2) * radius * Sign + OffY)) 
	RandX += Round((OutX * radius + OffX)) 
	GuiControl,, NB, %x%
	Found := 0
	while (Found == 0)
	{
