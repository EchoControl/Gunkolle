...
CheckWindow()
{
	...
	IfWinExist, ahk_id %uid%
	{
		...
		if (TWinW != WinW or TWinH != WinH)
		{
			...
			FindClick(A_ScriptDir "\pics\WaitForHome", "rNoxPlayer mc o30 Count1 n0 a1200,,,-600")
;			RPixelSearch()
		}
	}
	else
...
SetWindow()
{
	...
	{	
		...
		FoundHomeScreen := FindClick(A_ScriptDir "\pics\WaitForHome", "rNoxPlayer mc o30 Count1 n0 a1200,,,-600")
